...
namespace tomato
{
	...
	void EditorTheme::SetFont()
	{
		...
		constexpr const char* regularFontPath	= "../bin/content/Resources/Fonts/jetbrains-mono/JetBrainsMono-Regular.ttf";
		constexpr const char* boldFontPath		= "../bin/content/Resources/Fonts/jetbrains-mono/JetBrainsMono-Bold.ttf";
